...
// http://www.facebook.com/dialog/pagetab?app_id=YOUR_APP_ID&next=YOUR_URL
 ...
 $CI = &get_instance();
    ...
    if(!$CI->facebook->getUser()){
	  return "<a onclick=\"fbDialogLogin('fb_login','".$CI->setting_m->get('APP_CANVAS_URL')."tab/".$CI->setting_m->get('APP_APPLICATION_ID')."'); return false;\" class=\"fb_button fb_button_medium\"><span class=\"fb_button_text\">".$text."</span></a>";
	}
	return null;
 }
