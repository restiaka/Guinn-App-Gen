...
.quickform label.element {
	...
	<body>
	<div id="content" class="container_16 clearfix" style="margin-top:50px;">
	<div class="grid_5" style="color:#fff;">.</div>
	<div class="grid_6">
	 <div class="box" style="margin-top:120px;margin-bottom:120px;">
